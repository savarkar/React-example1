...
const CourseDetails = (props: Props) => {
    ...
    return (
        <>
            ...
            <div>
                <Commonheader />
                <div className='bg-darklight mb-5'>
                    <div className="container h-100 mt-5 p-3">
                        <div className="d-flex flex-column justify-content-center h-100 ">
                            <span style={{ width: '40px', height: '40px' }} className='border rounded-circle p-2 text-center bg-home'><i className="fa fa-angle-left"></i></span>
                            ...
                            <div className='d-flex justify-content-between'>
                                <div className='col-lg-4 row no-flexwrap h-50'>
